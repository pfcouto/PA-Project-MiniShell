...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->UTF8_arg = NULL;
  args_info->UTF8_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->UTF8_help = gengetopt_args_info_help[4] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->UTF8_arg));
  free_string_field (&(args_info->UTF8_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->UTF8_given)
    write_into_file(outfile, "UTF8", args_info->UTF8_orig, 0);
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->UTF8_given)
    {
      fprintf (stderr, "%s: '--UTF8' ('-u') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVi:p:u:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'u':	/* string UTF8.  */
          ...
          if (update_arg( (void *)&(args_info->UTF8_arg), 
               &(args_info->UTF8_orig), &(args_info->UTF8_given),
              &(local_args_info.UTF8_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "UTF8", 'u',
              additional_error))
            goto failure;
